...
from fastapi.security import OAuth2AuthorizationCodeBearer, OAuth2PasswordRequestForm, oauth2
...
register_tortoise(
    app,
    db_url="postgres://postgres:postgres@localhost:5432/auth_learn",
    modules={'models': ['main']},
